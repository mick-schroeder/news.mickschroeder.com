...
const Redirecter = () => {
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center">
        <div className="bg-neutral-200 dark:bg-neutral-700 rounded-lg p-8 shadow-md my-16 flex flex-col items-center justify-center ">
          <p className="text-xl font-bold mb-4 text-black dark:text-neutral-300">
            <Trans i18nKey="redirect.heading" />
          </p>
          <div role="status">
            <svg
              aria-hidden="true"
              className="w-16 h-16 text-neutral-200 animate-spin dark:text-neutral-600 fill-green-600"
              viewBox="0 0 100 101"
              fill="none"
  ...
  return (
    <div className="flex items-center justify-center">
      <div className="bg-neutral-200 dark:bg-neutral-700 rounded-lg p-8 shadow-md">
        <p className="text-xl font-bold mb-4 text-black dark:text-neutral-300">
          <Trans i18nKey="redirect.heading" />
        </p>
        ...
        <p className="text-green-500 dark:text-green-300 font-medium">
          {nextSite}
        </p>
      </div>
    </div>
